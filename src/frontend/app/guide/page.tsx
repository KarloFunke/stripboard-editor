  ...
  return (
    <div className="min-h-screen bg-[#fafafa] flex flex-col">
      ...
      <div className="max-w-3xl mx-auto px-6 py-12 flex-1">
        <h1 className="text-2xl font-bold text-[#113768] mb-6">Quick Guide</h1>

        {/* Workflow */}
        <section className="mb-10">
          <h2 className="text-lg font-semibold text-neutral-800 mb-3">Workflow</h2>
        ...
        <section className="mb-10">
          ...
          />
          <p className="text-xs text-neutral-400 mt-2 text-center">A finished project: schematic on the left, stripboard layout on the right.</p>
        </section>

        {/* Schematic Editor */}
        <section className="mb-10">
          <h2 className="text-lg font-semibold text-neutral-800 mb-3">Schematic Editor (left)</h2>
          <ul className="space-y-2 text-sm text-neutral-700">
            <li>Drag components from the library sidebar onto the canvas.</li>
            <li>Press <kbd className="px-1.5 py-0.5 bg-neutral-100 border border-neutral-300 rounded text-xs font-mono">W</kbd> to enter wire drawing mode, then click pins to connect them.</li>
        ...
        {/* Stripboard Editor */}
        <section className="mb-10">
          <h2 className="text-lg font-semibold text-neutral-800 mb-3">Stripboard Editor (right)</h2>
          <ul className="space-y-2 text-sm text-neutral-700">
        ...
        {/* Keyboard Shortcuts */}
        <section className="mb-10">
          <h2 className="text-lg font-semibold text-neutral-800 mb-3">Keyboard Shortcuts</h2>
          <div className="grid grid-cols-2 gap-x-8 gap-y-1.5 text-sm">
            {[
              ...
              <div key={key} className="contents">
                <kbd className="px-1.5 py-0.5 bg-neutral-100 border border-neutral-300 rounded text-xs font-mono text-neutral-800 justify-self-start">
                  {key}
                </kbd>
        ...
        {/* Custom Components */}
        <section className="mb-10">
          <h2 className="text-lg font-semibold text-neutral-800 mb-3">Custom Components</h2>
        ...
        {/* Saving & Sharing */}
        <section className="mb-10">
          <h2 className="text-lg font-semibold text-neutral-800 mb-3">Saving &amp; Sharing</h2>
          <ul className="space-y-2 text-sm text-neutral-700">
