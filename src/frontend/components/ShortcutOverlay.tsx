...
const SHORTCUTS = [
  ...
  { section: "Stripboard", items: [
    ["Ctrl / Shift + click", "Add or toggle parts, link wires and cuts in the selection"],
    ...
    ["Arrow keys / Drag", "Move the selection, one or many; dragging any part, wire or cut of it moves all"],
