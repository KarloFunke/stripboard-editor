        ...
        <div className="flex gap-2 mb-3">
          <div className="flex-1">
            ...
            <input
              ...
              className="w-full border border-neutral-300 rounded px-2 py-1 text-sm text-neutral-900 outline-none focus:border-blue-400"
            />
          </div>
          <div className="w-16">
            <label className="block text-xs text-neutral-700 mb-1">Prefix</label>
            <input
              value={prefix}
              onChange={(e) => setPrefix(e.target.value)}
              maxLength={3}
              className="w-full border border-neutral-300 rounded px-2 py-1 text-sm text-neutral-900 outline-none focus:border-blue-400 text-center"
            />
          </div>
        </div>
